 ...
 */
public class CreateTransactionJPanel extends javax.swing.JPanel {
...
// Transcation t;
    public CreateTransactionJPanel(JPanel container, Business business,
            //            Customer c,
//            Organization o,
            UserAccount ua
//            Transcation t
...
//        populateEnterprise();
    ...
    for(UserAccount c: business.getUserAccountDirectoty().getUserAccountList()){
           if(!c.getUserName().equals("admin")&&!c.getUserName().equals("ad")){
...
//        String paymentMethod = (String) paymentMethodJComboBox.getSelectedItem();
