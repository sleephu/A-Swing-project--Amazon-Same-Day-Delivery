...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
   ...
   Business business) {
        ...
        departmentDirectory = business.getDepartmentDirectory();
        populateTableData();
        populateTypeCombo();
//        System.out.println("bu"+business.getDepartmentDirectory().getDepartmentList());
    }
    private void populateTypeCombo(){
    for(OrganizationType t: Organization.OrganizationType.values()){
        if(t.equals(Organization.OrganizationType.AmazonAccountingDept)||t.equals(Organization.OrganizationType.CustomerDept)||t.equals(Organization.OrganizationType.AmazonSalesDept)||t.equals(Organization.OrganizationType.AmazonShippingDept))
...
private void populateTableData(){
    ...
    private void initComponents() {
        ...
        add(creJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, -1, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, -1, -1));
